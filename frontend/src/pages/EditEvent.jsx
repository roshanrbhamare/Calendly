    ...
    useEffect(() => {
        if (slug) {
            api.get(`/event-types/${slug}`)
                .then(res => {
                    console.log('📋 Event data received from API:', res.data);
                    console.log('✓ Description value:', res.data.description);
        ...
        <div className="p-12 max-w-6xl w-full bg-background text-on-surface h-full overflow-y-auto">
            ...
            <div className="mb-12 flex items-end justify-between">
                <div className="space-y-2">
                    ...
                    <h1 className="text-display-lg text-5xl font-extrabold tracking-tight text-on-surface">Edit Event Type</h1>
                    <p className="text-on-surface-variant font-body leading-relaxed max-w-xl">Update the details for your scheduling link.</p>
                </div>
                <div className="flex gap-3">
                    ...
                    <button onClick={handleSubmit} className="px-8 py-3 rounded-xl font-plus-jakarta text-sm font-semibold bg-gradient-to-br from-primary to-primary-container text-white shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all">Update Event Type</button>
                </div>
            </div>
